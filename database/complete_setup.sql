-- =====================================================
-- GCG Maturity Assessment - Complete Database Setup
-- File: complete_setup.sql
-- Database: gcg
-- Run this file manually in Navicat Query Tool
-- =====================================================
...
-- =====================================================
-- 1. ADD KKA FIELDS TO ASSESSMENT TABLE (Migration)
-- =====================================================

-- Add KKA fields to existing assessment table
DO $$ 
BEGIN
    -- Check if columns already exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                   WHERE table_name = 'assessment' AND column_name = 'kka_number') THEN
        
        -- Add KKA fields
        ALTER TABLE assessment 
        ADD COLUMN kka_number VARCHAR NOT NULL DEFAULT 'KKA-001',
        ADD COLUMN kka_name VARCHAR NOT NULL DEFAULT 'Tata Kelola Perusahaan';
        
        -- Add indexes for new fields
        CREATE INDEX idx_assessment_kka_number ON assessment(kka_number);
        CREATE INDEX idx_assessment_kka_name ON assessment(kka_name);
        
        RAISE NOTICE 'KKA fields added successfully to assessment table';
    ELSE
        RAISE NOTICE 'KKA fields already exist in assessment table';
    END IF;
END $$;
...
-- =====================================================
-- 4. INSERT ASSESSMENT DATA WITH KKA
-- =====================================================
...
SELECT 
    ...
    (SELECT COUNT(*) FROM kka) as total_kka,
